...
class create_maintenance_window(forms.Form):
  cluster_name = forms.ChoiceField(
      ...
      widget=forms.Select(
          attrs={
            'class': 'btn btn-secondary dropdown-toggle col-lg-4 col-sm-12 col-md-8'}
      )
  )
  ...
  window_name = forms.CharField(
      ...
      widget=forms.TextInput(
          attrs={'class': 'form-control col-lg-4 col-sm-12 col-md-8'})
  )
  ...
  window_day_of_month = forms.ChoiceField(
      ...
      widget=forms.Select(
          attrs={
              'class': 'form-control btn btn-secondary dropdown-toggle col-lg-4 col-sm-12 col-md-8'}
      )
  )
...
class window_filters(forms.Form):
  ...
  entity_type = forms.ChoiceField(
      ...
      widget=forms.Select(
          attrs={
              'class': 'btn btn-secondary dropdown-toggle col-lg-2 col-sm-12 col-md-8'}
      )
  )
